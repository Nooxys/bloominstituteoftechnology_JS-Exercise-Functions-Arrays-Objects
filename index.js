...
console.log(`la temperatura in F è: ${temperatureCtoF(24)}`)
/**
 ...
 */
/* code here */
function temperatureInF(num, discrim) {
  if (discrim.toLowerCase() === 'f') {
    return num + discrim
  } else {
    return temperatureCtoF(num)
  }
}
console.log(`la temperatura è: ${temperatureInF(24, 'C')}`)
/**
...
function makePersonObject(id, name, email) {
  if (Number.isInteger(id)) {
    ...
    console.log('Inserire un numero in ID')
  }
}
...
console.log(getLastCarInfo(listone))
/**
...
function getModelYears(array) {
  const carYear = array.map((elem) => elem.car_year)
  /* code here */ return carYear
}
console.log(getModelYears(listone))
// const getModelYears = (array) => {
//   const carYear = []
...
console.log(getCarInfoById(listone, 1))
/**
...
function getOlderCars(array, number) {
  const carYear = array.filter((elem) => elem.car_year <= number)
  /* code here */ return carYear
}
console.log(getOlderCars(listone, 2000))
/* code here */
...
function getGermanCars(array) {
  const carNat = array.filter(
    (elem) =>
      elem.car_make === `Audi` ||
      elem.car_make === `Mercedes-Benz` ||
      elem.car_make === `Volkswagen` ||
      elem.car_make === `BMW`
  )

  /* code here */ return carNat

  /* code here */
}
console.log(getGermanCars(listone))
/**
 * ### Challenge `carMaker`
 * THIS ONE IS A STRETCH GOAL. ATTEMPT IT ONLY AFTER
 * COMPLETING ALL NON-STRETCH CHALLENGES IN THE REPOSITORY!
